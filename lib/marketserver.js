...
var MarketServer = function(server) {
    ...
    this.getMarketItems = function(cb) {
        var url = server + "/StrategyStoreSvc/api/strategies/digest?appid=DAQ&format=json&validonly=false";
    ...
    this.addMarketItem = function(guid, name, cb) {
        var url = server + "/StrategyStoreSvc/api/strategies";
    ...
    this.updateMarketItemStatus = function(guid, marketId, status, cb) {
        var url = server + "/StrategyStoreSvc/api/strategies/" + marketId;
        var item = {
            ID: marketId,
            AppID: "DAQ",
            AuthorID : "sysjust",
